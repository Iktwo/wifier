...
package com.iktwo.wifier.views;
...
import com.iktwo.wifier.BuildConfig;
 ...
 * the measure pass.
 */
public class CustomLinearLayout extends android.support.v7.widget.LinearLayoutManager {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public CustomLinearLayout(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public CustomLinearLayout(RecyclerView view, int orientation, boolean reverseLayout) {
